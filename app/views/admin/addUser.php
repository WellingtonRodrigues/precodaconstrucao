	...
	<div class="container">
		<div class="row text-center">
			...
			<div class="col-sm-6 well">
				...
				<br>
				<form
					action="http://localhost/precodaconstrucao/public/admin/usuarios/add"
					...
					<div class="form-group">
						<label class="control-label col-sm-4" for="senhaUser">Senha:</label>
						<div class="col-sm-8">
							<input type="password" class="form-control" name="senhaUser"
								id="senhaUser" required="true">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4" for="confSenhaUser">Confirmação
							da senha:</label>
						<div class="col-sm-8">
							<input type="password" class="form-control" name="confSenhaUser"
								id="confSenhaUser" required="true">
						</div>
					</div>
					<br>
					<div class="form-group">
